...
int main()
{
    ...
    // load the mesh
    s.load_mesh("simulations/sala_config_05_PRATO/inputs/test1.bdf");
    ...
    s.export_result("simulations/sala_config_05_PRATO/outputs/result_sala_config_05_PRATO.nmvr");
}
